...
return [
    ...
    | версий, например правила размера. Вы можете изменять эти сообщения
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Значение :attribute было обнаружено в утечке данных. Пожалуйста, выберите другое значение.',
    ],
