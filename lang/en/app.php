...
return [
    ...
    'label' => [
        ...
        'login' => 'Login',
        'welcome' => 'Welcome',
        'welcome_description' => 'A modern and powerful platform for managing your project',
        'go_to_dashboard' => 'Go to Dashboard',
        'get_started' => 'Get Started',
        'feature_secure' => 'Security',
        'feature_secure_desc' => 'Reliable data protection and access control',
        'feature_fast' => 'Performance',
        'feature_fast_desc' => 'Fast operation and optimized code',
        'feature_multilang' => 'Multilingual',
        'feature_multilang_desc' => 'Multiple language support out of the box',
